...
pub struct McpApps {
    ...
    #[serde(
        ...
        alias = "piCodingAgent",
        alias = "pi_coding_agent",
        default
    )]
    pub pi_coding_agent: bool,
}
...
impl McpApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::Pi => self.pi_coding_agent,
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::Pi => self.pi_coding_agent = enabled,
...
impl Default for McpRoot {
    fn default() -> Self {
        Self {
            ...
            pi_coding_agent: McpConfig::default(),
        }
    }
}
...
pub struct PromptRoot {
    ...
    pub pi_coding_agent: PromptConfig,
}
...
impl FromStr for AppType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match normalized.as_str() {
            ...
            "pi-coding-agent" | "pi_coding_agent" | "picodingagent" | "pi" => {
                Ok(AppType::Pi)
            }
...
impl CommonConfigSnippets {
    ...
    pub fn get(&self, app: &AppType) -> Option<&String> {
        match app {
            ...
            AppType::Pi => self.pi_coding_agent.as_ref(),
        }
    }
    ...
    pub fn set(&mut self, app: &AppType, snippet: Option<String>) {
        match app {
            ...
            AppType::Pi => self.pi_coding_agent = snippet,
        }
    }
}
...
impl MultiAppConfig {
    ...
    pub fn load() -> Result<Self, AppError> {
        ...
        if let Some(legacy_pi_manager) = config.apps.remove("pi-coding-agent") {
            let pi_manager = config.apps.entry("pi".to_string()).or_default();
            for (id, provider) in legacy_pi_manager.providers {
                pi_manager.providers.entry(id).or_insert(provider);
            }
            if pi_manager.current.is_empty() {
                pi_manager.current = legacy_pi_manager.current;
            }
            updated = true;
        }
    ...
    pub fn mcp_for(&self, app: &AppType) -> &McpConfig {
        match app {
            ...
            AppType::Pi => &self.mcp.pi_coding_agent,
        }
    }
    ...
    pub fn mcp_for_mut(&mut self, app: &AppType) -> &mut McpConfig {
        match app {
            ...
            AppType::Pi => &mut self.mcp.pi_coding_agent,
        }
    }
    ...
    fn maybe_auto_import_prompts_for_existing_config(&mut self) -> Result<bool, AppError> {
        ...
        if !self.prompts.claude.prompts.is_empty()
            ...
            || !self.prompts.pi_coding_agent.prompts.is_empty()
        {
            return Ok(false);
        }
    ...
    fn auto_import_prompt_if_exists(config: &mut Self, app: AppType) -> Result<bool, AppError> {
        ...
        let prompts = match app {
            ...
            AppType::Pi => &mut config.prompts.pi_coding_agent.prompts,
        };
