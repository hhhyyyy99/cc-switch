...
pub struct AppSettings {
    ...
    #[serde(
        rename = "piConfigDir",
        alias = "pi_config_dir",
        alias = "piCodingAgentConfigDir",
        alias = "pi_coding_agent_config_dir",
        default,
    ...
    #[serde(
        rename = "currentProviderPi",
        alias = "current_provider_pi",
        alias = "currentProviderPiCodingAgent",
        alias = "current_provider_pi_coding_agent",
        default,
        skip_serializing_if = "Option::is_none"
    )]
