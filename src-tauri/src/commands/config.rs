...
pub async fn get_config_status(
    ...
    match AppType::from_str(&app).map_err(|e| e.to_string())? {
        ...
        AppType::Pi => {
            let dir = crate::pi_config::get_pi_dir();
            let exists = dir.exists()
                || crate::pi_config::get_pi_models_path().exists()
                || crate::pi_config::get_pi_settings_path().exists()
                || crate::pi_config::get_pi_auth_path().exists();
